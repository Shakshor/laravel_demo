...
<body class="h-full">
    ...
    <div class="min-h-full">
        ...
        <header
            class="relative bg-gray-950/50 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10"
        >
